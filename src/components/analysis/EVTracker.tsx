      ...
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={data}>
          ...
          <XAxis
            ...
            tickLine={false}
            label={{ value: 'Hand #', position: 'insideBottom', offset: -5, fill: '#64748b', fontSize: 11 }}
          />
          <YAxis
            tick={{ fill: '#94a3b8', fontSize: 12 }}
            axisLine={{ stroke: '#334155' }}
            ...
            label={{ value: 'EV (BB)', angle: -90, position: 'insideLeft', fill: '#64748b', fontSize: 11 }}
          />
          ...
          <Tooltip
            ...
            formatter={(value: number) => [`${value.toFixed(2)} BB`, 'Cumulative EV']}
