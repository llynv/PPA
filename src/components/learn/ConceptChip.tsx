...
export function ConceptChip({ concept, mastery }: ConceptChipProps) {
    ...
    return (
        <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-slate-700 px-3 py-1 text-xs font-medium text-neutral-200 hover:bg-slate-600 transition-colors"
        >
            <span
